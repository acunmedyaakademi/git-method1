...
namespace acunMedyaÖdev2
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // TO UPPER-TO LOWER(TO UPPER-büyük harfle yazar TOLOWER-küçük harfle yazar)
            ...
            //INDEX OF(metindeki karakterin kaçıncı karakter oldugunu verir.)
            /*  string ifade1 = "Ben kodlama ogrenıyorum";
            ...
            // LAST INDEX OF(aradığın karakterin son bulunduğu yerinkaçıncı yer olduğunu verir.)
            /* string mesaj = "Karışık Notlar";
             string aranan = "a";
             Console.WriteLine(mesaj.LastIndexOf(aranan));
             Console.ReadLine();*/

             // CONTAIN(aradığımız kelimenin metnin içerisinde olup olmadığını veren metotdur.)
             /*
             string ifade1 = "Ben kodlama ogrenıyorum";
            ...
            //STARTSWITH(Kelimenin başlangıç harfini kontrol eder.)
            /*  string ifade1 = "Ben kodlama ogrenıyorum";
            ...
            //ENDSWITH(kelimenin son harfini kontrol eder)
            /* string ifade1 = "Ben kodlama ogrenıyorum";
            ...
            //SPLIT(belirlediğimiz karakteri görünce bölmeyi sağlayan fonksiyondur.)
            ...
            //TRIM(baştan ve sondan bırkatığımız boşlukları silmeyi sağlar.)
